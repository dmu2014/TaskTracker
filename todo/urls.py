...
urlpatterns = patterns(
    ...
    url(r'^childlist/(?P<parentId>[0-9]+)/$', 'todo.views.postchild_list', name="postchild_list"),
    url(r'^mylist/$', 'todo.views.my_tasks', name="my_tasks"),
    ...
    url(r'^todo/newchild/(?P<pk>[0-9]+)$', 'todo.views.postchild_new', name='postchild_new'),
